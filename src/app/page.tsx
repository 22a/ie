  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 backdrop-blur-sm flex items-center justify-center">
        <main className="flex items-center justify-center m-auto max-w-[70%] px-24 py-8 backdrop-blur-sm bg-foreground bg-opacity-75 text-background  box-border shadow-sm rounded-lg">
